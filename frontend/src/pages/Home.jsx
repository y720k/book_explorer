...
const Home = () => {
    ...
    const fetchBooks = async (query = "") => {
        ...
        try {
            const response = await fetch(`https://openlibrary.org/search.json?q=${query ? encodeURIComponent(query) : "bestsellers"}&limit=30`);
            ...
            setBookList((!searchTerm? shuffleArray(data.docs) : data.docs) || [])
    ...
    // wait with fetching until user stops typing
