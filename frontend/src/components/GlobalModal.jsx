...
const GlobalModal = () => {
    ...
    const {currentBook, currentDescription, setCurrentDescription} = useBookContext();
    ...
    return (
        <div className="modal-overlay" onClick={onModalExist}>
            <div className="description-modal-content" onClick={(e) => e.stopPropagation()}>
                <h2 className="text-xl font-bold mb-3">{currentBook.title}</h2>
                
                <div>{currentDescription === "" ? (
